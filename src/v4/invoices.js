...
import { invoiceLine, invoiceTotals, invoiceDue, VAT_RATE } from './hr-statutory.js';
  ...
  return `<div class="inv-doc">
    <div class="inv-head">
      <div><div class="inv-title">${currentLang() === 'ar' ? s.nameAr || s.nameEn : s.nameEn}</div>
        <div style="font-size:12px;color:var(--text-muted)" dir="auto">CR ${s.cr || '—'} · ${s.address || ''}</div></div>
